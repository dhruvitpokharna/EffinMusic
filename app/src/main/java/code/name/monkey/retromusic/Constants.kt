...
const val SHOW_SONG_MENU_GRID = "show_song_menu_grid"
const val SHOW_SONGS_SEARCH_BUTTON = "show_songs_search_button"
const val SHOW_COVERS_IN_SONGS_TAB = "show_covers_in_songs_tab"
const val SWAP_SHUFFLE_REPEAT_BUTTONS = "swap_shuffle_repeat_buttons"
const val SHOW_ARTIST_IN_SONGS = "show_artist_in_songs"
const val SONG_TEXT_SIZE = "song_text_size"
const val ARTIST_TEXT_SIZE = "artist_text_size"
const val HIDE_DUPLICATE_SONGS = "hide_duplicate_songs"
const val PREFER_HIGHER_BITRATE_SONGS = "prefer_higher_bitrate_songs"
